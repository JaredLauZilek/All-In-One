...
- **Actual workouts** flow in from Strava (runs/rides/swims — Garmin syncs to Strava)
  and Hevy (lifts, full set/rep detail) and are auto-matched to planned sessions.
